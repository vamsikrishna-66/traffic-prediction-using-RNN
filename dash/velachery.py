...
df = pd.read_csv(r"C:\Users\Vamsi\Desktop\Geospatial-and-Transportation-Engineering\dashboard\day1.csv")
...
def update_output(value):
    ...
    day = pd.read_csv(r"C:\Users\Vamsi\Desktop\Review\dash\velacherry.csv",skiprows={0}, usecols= [value])
    print(value)
    # dm = pd.DataFrame(mon)
